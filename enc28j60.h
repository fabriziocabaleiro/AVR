...
/* Data offset with respect to SRAM_ENC, this macros can be generated by:
 * avr-nm -a Objs/enc28j60.o |grep SRAM | sort | awk '$2 ~ "[dD]"{ sub("SRAM_", "", $3); printf "#define %-25s %s\n", $3, "0x"$1 }'
 */
#define ENC_DATA                  0x00000000
#define ENC_RPKT_HEADER           0x00000000
#define ENC_RPKT_N_PKT_L          0x00000000
#define ENC_RPKT_N_PKT_H          0x00000001
#define ENC_RPKT_BC_L             0x00000002
#define ENC_RPKT_BC_H             0x00000003
#define ENC_RPKT_STATUS1          0x00000004
#define ENC_RPKT_STATUS2          0x00000005
#define ENC_ETH_DST_ADDR          0x00000006
#define ENC_ETH_HEADER            0x00000006
#define ENC_ETH_SRC_ADDR          0x0000000c
#define ENC_ETH_TYPE_LEN          0x00000012
#define ENC_ETH_TYPE_LEN_H        0x00000012
#define ENC_ETH_TYPE_LEN_L        0x00000013
#define ENC_MAC_DST_PTR           0x00000014
#define ENC_TYPE_LEN_OFFSET       0x00000016
